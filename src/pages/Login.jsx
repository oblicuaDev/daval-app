    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-white bg-opacity-20 rounded-2xl mb-4 shadow-lg">
            <span className="text-white font-bold text-2xl">O</span>
          </div>
          <h1 className="text-4xl font-bold text-white tracking-tight">Oblicua DEMO</h1>
          <p className="text-blue-200 mt-2 text-sm">Sistema de Gestión Comercial</p>
        </div>
        ...
        <p className="text-center text-blue-300 text-xs mt-6">
          Oblicua DEMO v0.1.0 — Solo para demostración
        </p>
      </div>
    </div>
  );
