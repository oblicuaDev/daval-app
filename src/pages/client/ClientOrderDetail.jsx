              ...
              <div>
                ...
                <div className="space-y-1 text-sm text-gray-400">
                  <p className="flex items-center gap-1.5">
                    ...
                    Creado: <span className="font-medium text-gray-300">{order.createdAt}</span>
                  </p>
                  <p className="flex items-center gap-1.5">
                    <User className="w-3.5 h-3.5" />
                    Solicitante: <span className="font-medium text-gray-300">{order.requestedByName || requestedBy?.name || '—'}</span>
                  </p>
                  <p className="flex items-center gap-1.5">
                    <Package className="w-3.5 h-3.5" />
                    Sucursal: <span className="font-medium text-gray-300">{order.sucursalName || 'Sin sucursal'}</span>
                  </p>
                  {advisor && (
                    <p className="flex items-center gap-1.5">
                      <User className="w-3.5 h-3.5" />
